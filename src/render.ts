...
export function renderGraph(
  ...
  const boxGrids = boxes ? packBoxComponents(layout, ir, boxes, moduleBandOf(ir)) : new Map<string, RowGrid>();
  ...
  if (boxes) {
    addBandBoxes(layout, new Map([...boxGrids, ...chains.grids]), footprints(ir));
