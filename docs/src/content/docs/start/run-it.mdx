...
1. Start it:
   ...
   No checkout? `npx @intentius/behold demo` runs the same demo from npm — it copies the example project to `./behold-demo` (yours to edit) and serves it the same way.
